@extends('layouts.master', ['title' => 'Card'])
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <p class="card-text">
                            ...
                            soufflé oat cake sweet roll. Sugar plum marzipan dragée topping cheesecake chocolate bar.
                            Danish
                            muffin icing donut.
                        </p>
                    </div>
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Cookie topping caramels jujubes gingerbread. Lollipop apple pie cupcake candy canes cookie
                            ice
            ...
            <div class="col-sm-6 col-lg-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">
                            This is another card with title and supporting text below. This card has some additional
                            content
